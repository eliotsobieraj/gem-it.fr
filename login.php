...
if (isset($_POST["username"]) && isset($_POST["password"])) {
    ...
    // Encoder le mot de passe fourni par l'utilisateur en SHA-256
...
<img src="images/GEM-IT.png" class="register-top-gem-it-logo" alt="">
<div class="registercontain">
    <div class="form-box">
        <form class="form" method="post">
            <span class="title">LOGIN</span>
            <span class="subtitle">Log onto your account.</span>
